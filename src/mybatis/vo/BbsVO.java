...
public class BbsVO {//DB에 저장된 컬럼명들을 맴버 변수로 똑같이 설정해준다!!
	private String b_idx,//DB의 게시판컬럼의 인덱스 값
				subject,
				writer,
				content,
				file_name,
				...
				hit,
				pwd,
				bname,//DB에 테이블을 따로 만들지 안고 컬럼만 투가하여 구분 하는 방법도 있다!!
				status;//실질적으로 삭제 하지 않고 숨김 처리 한다!!
